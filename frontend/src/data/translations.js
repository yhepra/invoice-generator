export const translations = {
  en: {
    ...
    pleaseLoginReceipts: "Please login to generate receipts.",
    selectInvoiceToPreviewReceipt: "Please select an invoice first to preview the receipt.",
    number: "Invoice No.",
    date: "Invoice Date",
    dueDate: "Due Date",
    ...
    receiptNotesPlaceholder: "For payment of (optional)",
    receiptTermsPlaceholder: "Additional notes (optional)",
    from: "From",
    billTo: "Bill To",
    item: "Item",
    ...
    emailMessageOptional: "Message (optional)",
    ...
    tourDone: "Done",
    tourClose: "Close",
    tourMissingTarget: "This step target is not visible on screen.",
    tourStepWelcomeTitle: "Welcome!",
    tourStepWelcomeBody: "This short tour shows you the main features to create and manage invoices.",
    tourStepCreateTitle: "Create Invoice",
    tourStepCreateBody: "Start creating a new invoice from here.",
    tourStepEditorTitle: "Fill Invoice Data",
    tourStepEditorBody: "Complete seller, customer, details, and items.",
    tourStepSaveTitle: "Save Invoice",
    tourStepSaveBody: "Save the invoice to History so you can edit and track it later.",
    tourStepHistoryTitle: "Invoice History",
    ...
    planPremiumYearlyPrice: "IDR 299,000",
    planPremiumYearlyPeriod: "/ year",
  ...
  id: {
    ...
    receipt: "KWITANSI",
    receipts: "Kwitansi",
    receiptsTitle: "Kwitansi",
    generateReceipt: "Buat Kwitansi",
    pleaseLoginReceipts: "Silakan login untuk membuat kwitansi.",
    selectInvoiceToPreviewReceipt: "Harap pilih faktur terlebih dahulu untuk melihat preview tampilan kwitansi.",
    number: "No. Faktur",
    date: "Tanggal Faktur",
    dueDate: "Jatuh Tempo",
    ...
    receivedFrom: "Telah Terima Dari",
    receivedBy: "Diterima Oleh",
    forPaymentOf: "Untuk Pembayaran",
    amountReceived: "Jumlah Diterima",
    inWords: "Terbilang",
    receiptNumberPlaceholder: "Nomor Kwitansi",
    receiptNotesPlaceholder: "Untuk pembayaran (opsional)",
    receiptTermsPlaceholder: "Catatan tambahan (opsional)",
    from: "Dari",
    billTo: "Kepada",
    item: "Barang",
    ...
    save: "Simpan",
    download: "Unduh",
    sendInvoiceEmail: "Kirim Faktur",
    emailTo: "Kepada",
    emailSubject: "Subjek",
    emailMessageOptional: "Pesan (opsional)",
    ...
    smtpEncryptionNone: "Tanpa enkripsi",
    smtpEncryptionTLS: "TLS",
    smtpEncryptionSSL: "SSL",
    ...
    tourDone: "Selesai",
    tourClose: "Tutup",
    tourMissingTarget: "Target langkah ini tidak terlihat di layar.",
    tourStepWelcomeTitle: "Selamat datang!",
    tourStepWelcomeBody: "Tour singkat ini menunjukkan fitur utama untuk membuat dan mengelola invoice.",
    tourStepCreateTitle: "Buat Invoice",
    tourStepCreateBody: "Mulai membuat invoice baru dari sini.",
    tourStepEditorTitle: "Isi Data Invoice",
    tourStepEditorBody: "Lengkapi data penjual, pelanggan, detail, dan item.",
    tourStepSaveTitle: "Simpan Invoice",
    tourStepSaveBody: "Simpan invoice ke History agar bisa diedit dan dilacak kembali.",
    tourStepHistoryTitle: "History Invoice",
    ...
    planPremiumYearly: "Premium (Tahunan)",
    planPremiumYearlyPrice: "IDR 299.000",
    planPremiumYearlyPeriod: "/ tahun",
