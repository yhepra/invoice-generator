...
export default function Landing({ user, onCreateInvoice, onLoadInvoice, onGoUpgrade, onLogin, onRegister, settings }) {
    ...
    return (
      <div className="mx-auto max-w-7xl p-4 md:p-8">
          ...
          <div className="mb-8 rounded-2xl bg-gradient-to-r from-orange-100 to-amber-100 p-6 shadow-sm border border-orange-200 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-lg font-bold text-gray-900">{t('unlockPremium')}</h3>
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-800">{t('recentInvoices')}</h2>
        ...
        {loading ? (
          <div className="py-12 text-center text-gray-500">{t('loadingDashboard')}</div>
        ) : recentInvoices.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 p-12 text-center">
            ...
            <h3 className="mb-2 text-lg font-medium text-gray-900">{t('noInvoicesYet')}</h3>
              ...
              <div key={inv.historyId} className="group relative flex flex-col justify-between rounded-xl border bg-white p-5 shadow-sm transition-all hover:border-brand-300 hover:shadow-md">
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-500">{inv.items.length} {t('itemsCount')}</p>
                  </div>
                </div>
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] flex-col bg-white">
      ...
      <section className="relative overflow-hidden bg-slate-900 px-4 py-20 text-center text-white md:px-8 md:py-32">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <p className="mt-6 text-sm text-slate-400">
            {t('alreadyHaveAccount')} <button onClick={onLogin} className="text-brand-400 hover:text-brand-300 underline font-medium">{t('loginRegister')}</button>
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">{t('painPointsTitle')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('painPointsSubtitle')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: t('ppTrackingTitle'), desc: t('ppTrackingDesc') },
              { title: t('ppProfessionalTitle'), desc: t('ppProfessionalDesc') },
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">{t('featuresTitle')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('featuresSubtitle')}</p>
          </div>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              { title: t('featFastTitle'), desc: t('featFastDesc'), icon: "M13 10V3L4 14h7v7l9-11h-7z", color: "blue" },
              { title: t('featSecureTitle'), desc: t('featSecureDesc'), icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "green" },
              { title: t('featLookTitle'), desc: t('featLookDesc'), icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z", color: "purple" },
              { title: t('featClientTitle'), desc: t('featClientDesc'), icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", color: "indigo" },
              { title: t('featHistoryTitle'), desc: t('featHistoryDesc'), icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", color: "yellow" },
              { title: t('featMobileTitle'), desc: t('featMobileDesc'), icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", color: "pink" },
            ].map((feature, idx) => (
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">{t('howItWorksTitle')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('howItWorksSubtitle')}</p>
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">{t('plansTitle')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('plansSubtitle')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Plan */}
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-200">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('planFree')}</h3>
              <p className="text-gray-500 mb-6">{t('planFreeDesc')}</p>
              <div className="text-4xl font-extrabold text-gray-900 mb-6">{t('planFreePrice')} <span className="text-base font-normal text-gray-500">{t('planFreePeriod')}</span></div>
              ...
              <Button onClick={onRegister} variant="outline" className="w-full">{t('startForFree')}</Button>
            </div>

            {/* Premium Plan */}
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-brand-500 relative transform md:-translate-y-4">
              <div className="absolute top-0 right-0 bg-brand-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">{t('recommended')}</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('planPremium')}</h3>
              <p className="text-gray-500 mb-6">{t('planPremiumDesc')}</p>
              <div className="text-4xl font-extrabold text-gray-900 mb-6">{t('planPremiumPrice')} <span className="text-base font-normal text-gray-500">{t('planPremiumPeriod')}</span></div>
              <ul className="space-y-4 mb-8">
                {[
              ...
              <Button onClick={onRegister} className="w-full">{t('getPremium')}</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">{t('faqTitle')}</h2>
          </div>
