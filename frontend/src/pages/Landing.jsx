      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: t("ppTrackingTitle"),
                desc: t("ppTrackingDesc"),
                icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01",
              },
              {
                title: t("ppProfessionalTitle"),
                desc: t("ppProfessionalDesc"),
                icon: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 2H7a2 2 0 00-2 2v17a2 2 0 002 2zm2-9l4 4m0-4l-4 4",
              },
              {
                title: t("ppLostDataTitle"),
                desc: t("ppLostDataDesc"),
                icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4",
              },
              {
                title: t("ppCalcErrorsTitle"),
                desc: t("ppCalcErrorsDesc"),
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              >
                <div
                  className={`mb-4 inline-block rounded-lg p-3 ${feature.colorClass}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
